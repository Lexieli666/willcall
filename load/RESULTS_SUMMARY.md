...
- **Coverage:** 86.47%.
- **Tests:** 110 run, 0 failed on the backend, 15 run, 0 failed end to end, plus the frontend unit suite. The combined figure is below 310 and the exact count is in the table above.
