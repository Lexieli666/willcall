...
export const options: Options = {
  ...
  thresholds: {
    // Zero is the whole point. A single 5xx during a sell-out fails the run.
...
export default function flash(data: { eventId: string }): void {
  ...
  // Most buyers who get a hold go on to pay. The ones who do not are the abandoned checkouts the
  // sweeper has to clean up, which is part of what this scenario exercises.
  if (__ITER % 10 === 0) return
